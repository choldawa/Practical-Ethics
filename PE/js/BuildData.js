var factors = {
    ...
    prompts_test: ["A bank must decide who to give home loans to. Only 10% of the loans can default and some groups are more likely to default than others, so giving loans to some people may result in less loans for others. How should the loans be allocated?",
        ...
        "Meals on Wheels is tasked with delivering meals to homebound persons. Their time and reseources are limited, and some groups live further away, so delivering to some groups may mean less deliveries to others. The numbers below represent how many meals are given to each group. How should they allocate their time for deliveries?"],
...
myData_test['prompts_test'].splice(attentionTrial,0,"This is a test trial to help calibrate your responses. Please move your slider all the way to the left. Thank you.");
