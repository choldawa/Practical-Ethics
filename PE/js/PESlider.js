...
function sliderChange(val) {
	...
	generateDots(fullSet, myData_test['datasets_test'][trialNumber][parseInt(val) + jitter].asian, 1);
	generateDots(fullSet, myData_test['datasets_test'][trialNumber][parseInt(val) + jitter].white, 2);
	generateDots(fullSet, myData_test['datasets_test'][trialNumber][parseInt(val) + jitter].hispanic, 3);
