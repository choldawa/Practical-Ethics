...
function sliderChange(val) {
	...
	// if(trialNumber == catchTrial){
	// 	generateDots(fullSet, catchDataset[parseInt(val) + jitter].g1, 1);
	// 	generateDots(fullSet, catchDataset[parseInt(val) + jitter].g2, 2);
	// 	generateDots(fullSet, catchDataset[parseInt(val) + jitter].g3, 3);
	// 	generateDots(fullSet, catchDataset[parseInt(val) + jitter].g4, 4);
	// 	generateDots(fullSet, catchDataset[parseInt(val) + jitter].mu, 5);
	// }else{
